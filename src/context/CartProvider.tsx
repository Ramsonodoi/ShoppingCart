...
const useCartContext = (initCartState: CartStateType) => {
    ...
    const totalPrice = new Intl.NumberFormat('en-US', {style: 'currency', currency: 'GHS'}).format(state.cart.reduce((previousValue, cartItem) =>{
        return previousValue + (cartItem.qty * cartItem.price)
    }, 0))

    const cart = [...state.cart];  // create a copy of the cart array
    cart.sort((a, b) => {
